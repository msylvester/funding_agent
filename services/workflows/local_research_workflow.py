...
#abstract out the associated methods for this class
...
#update this method to use the web_search_agent to make an inference

async def run_research_agent(input_text: str) -> Any:
    ...
    return web_research_agent_result_temp
...
async def run_research_workflow(input_text: str) -> dict[str, Any]:
    ...
    with trace("New workflow"):
        ...
        web_research_agent_result_temp = await run_research_agent(workflow["input_as_text"])
